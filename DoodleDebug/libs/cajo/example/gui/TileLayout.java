...
public final class TileLayout implements LayoutManager2, Serializable {
   ...
   private void align(Dimension cont, Object cons[], Component comp) {
      ...
      Rectangle
         pref = new Rectangle(tile.getLocation(), comp.getPreferredSize());
           ...
           if ((align & 0x001000) != 0) pref.setBounds(tile.x, pref.y, tile.width, pref.height);
      else if ((align & 0x002000) != 0) pref.width = tile.width - pref.x;

           if ((align & 0x020000) != 0) pref.setBounds(pref.x, tile.y, pref.width, tile.height);
      else if ((align & 0x040000) != 0) pref.height = tile.height - pref.y;
   ...
   public static final int
      NOINDENT     = 0x000000, LEFTINDENT  = 0x000001,
      CENTERINDENT = 0x000002, FULLINDENT  = 0x000004,
      RIGHTINDENT  = 0x000008, FIXEDINDENT = 0x000010,
      PROPINDENT   = 0x000020,

      NOOFFSET     = 0x000000, TOPOFFSET   = 0x000040,
      CENTEROFFSET = 0x000080, FULLOFFSET  = 0x000100,
      BOTTOMOFFSET = 0x000200, FIXEDOFFSET = 0x000400,
      PROPOFFSET   = 0x000800,

      PREFWIDTH    = 0x000000, CLAMPLEFT   = 0x001000,
      CLAMPRIGHT   = 0x002000, FIXEDWIDTH  = 0x004000,
      PROPWIDTH    = 0x008000, FULLWIDTH   = 0x010000,

      PREFHEIGHT   = 0x000000, CLAMPTOP    = 0x020000,
      CLAMPBOTTOM  = 0x040000, FIXEDHEIGHT = 0x080000,
   ...
   public void layoutContainer(Container parent) {
      ...
      for (int i = components.size() - 1; i > 0; i--)
         align(container, (Object[])components.elementAt(i--),
